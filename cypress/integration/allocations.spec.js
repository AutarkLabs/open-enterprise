...
////////////////////////////////////////////////////////////////////////////////////////
  ...
  context('Allocations', () => {
    it('creates New Account', () => {
      ...
      //////// check
      cy.get('iframe').iframe().contains('div', ALLOC1)
      //////// create Alloc account END ////////////
      cy.wait(3000)
      ...
      .get('iframe').iframe().find('input[name="amount"]').type('')
      .get('iframe').iframe().wait(3000).find('div').each((el) => {
