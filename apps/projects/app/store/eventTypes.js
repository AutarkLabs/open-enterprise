...
export const SUBMISSION_REJECTED = 'SubmissionRejected'
export const WORK_SUBMITTED = 'WorkSubmitted'
export const SUBMISSION_ACCEPTED = 'SubmissionAccepted'
export const ISSUE_CURATED = 'IssueCurated'
export const BOUNTY_SETTINGS_CHANGED = 'BountySettingsChanged'
export const VAULT_DEPOSIT = 'VaultDeposit'
